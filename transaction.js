            ...
            const ListTransaction = {
                ...
                resetFormTransaction: function(form) {
                    ...
                    form.names.value = this.Transaction.names;
                ...
                showListTransaction: function () {
                    ...
                    if (this.ListTransaction === null) {
                        ...
                        componentListTransaction.innerHTML +=  `<h4>
                        <div class="flex justify-center gap-5"> 
                            <div class="card-actions justify-end"> ${Transaction.consumer} <br> ${Transaction.product} <br>
                                price: ${Transaction.price} <br> stock: ${Transaction.stock} <br> amount: ${Transaction.amount}  <br> Total: ${Transaction.total} <br> cash: 
                                ${Transaction.cash} <br> changes: ${Transaction.changes}  <img src="${Transaction.pictures}" width= "100px">
                                <button class="btn btn-accent btn-active" onclick="ListTransaction.deleteTransaction(${index})"> delete </button>
                            </div>
                        </div>
                        </h4>`;
                        });
